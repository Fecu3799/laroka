package com.pedisur.backend.order.mapper;
...
import com.pedisur.backend.order.dto.BackofficeOrderDetailDTO;
import com.pedisur.backend.order.dto.BackofficeOrderItemDTO;
import com.pedisur.backend.order.dto.BackofficeOrderResponseDTO;
import com.pedisur.backend.order.dto.CreateOrderRequestDTO;
import com.pedisur.backend.order.dto.CreateOrderResponseDTO;
import com.pedisur.backend.order.dto.OrderDiscountDTO;
import com.pedisur.backend.order.dto.OrderItemResponseDTO;
import com.pedisur.backend.order.dto.OrderItemStatusDTO;
import com.pedisur.backend.order.dto.OrderStatusHistoryDTO;
import com.pedisur.backend.order.dto.OrderStatusResponseDTO;
...
import com.pedisur.backend.order.service.AppliedDiscount;
import com.pedisur.backend.order.service.BackofficeOrderDetail;
...
public class OrderMapper {
    ...
    public BackofficeOrderDetailDTO toBackofficeDetailDTO(BackofficeOrderDetail detail) {
        ...
        String cancellationReason = detail.history().stream()
                .filter(h -> (h.getToStatus() == com.pedisur.backend.order.entity.OrderStatus.CANCELLED
                        || h.getToStatus() == com.pedisur.backend.order.entity.OrderStatus.CANCELLATION_REQUESTED)
