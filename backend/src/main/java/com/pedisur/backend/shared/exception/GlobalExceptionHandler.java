package com.pedisur.backend.shared.exception;
...
import com.pedisur.backend.media.exception.StorageException;
import com.pedisur.backend.notification.email.EmailDeliveryException;
